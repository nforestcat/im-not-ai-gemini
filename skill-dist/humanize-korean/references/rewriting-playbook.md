...
| 원문 패턴 (자소서) | 윤문 레시피 |
|-----------|----------|
| 저에게 ~를 가르쳐 주었습니다 | ~를 통해 ~를 배웠습니다 / 깨달았습니다 |
| ~성장시켰습니다 / ~하게 해주었습니다 | ~하며 성장했습니다 / ~를 완수했습니다 |
| 이바지할 준비가 되어 있습니다 | ~한 역량으로 ~를 달성하겠습니다 / 기여하겠습니다 |
| ~라고 생각합니다 / ~인 것 같습니다 | ~라고 확신합니다 / ~임을 확인했습니다 / (단언형으로 수정) |
| 다양한 경험을 쌓아왔습니다 | (구체적 사례 명시): "X 프로젝트에서 Y를 수행하며..." |
| 귀사 / 이 회사 / 이곳 | (실제 사명으로 치환): "삼성전자", "네이버" 등 |

#### [자기소개서 윤문 방법론 (Self-Introduction Methodology)]

1. **[현상 분석] + [나의 역할] 배합**: 첫 문단에서 기술적 통찰(현상)을 먼저 제시하고, 그 문제를 해결하려는 지원자의 의지(역할)를 1인칭 능동태로 연결한다.
2. **기술 키워드의 서사적 통합**: 전문 용어(Redis, CQRS 등)를 단순히 나열하지 않고, '먼저 ~를 구축하고, 나아가 ~를 설계한다'는 실행 로드맵 속에 자연스럽게 배치한다.
3. **기계적 대구(Parallelism) 탈피**: AI 특유의 '단기적/장기적', '첫째/둘째' 구조를 버리고 '먼저/나아가/이 과정에서'와 같은 서사적 연결어를 사용하여 글의 흐름을 유기적으로 만든다.
4. **Hype 형용사 대신 실무 동사**: '최고의', '압도적인' 같은 미사여구 대신 '직접 돌파하는', '현장에서 증명하는', '성패를 결정하는' 등 엔지니어링 실무 감각이 느껴지는 동사를 우선 사용한다.

### 1.X. 영-한 PE 통합 체크리스트
 (보고서 §5.1, 15항목 · v2.0 신규)
...
| 자기소개서 | 구체적 수치, 성과 중심 능동태, 1인칭 주체성 | "~인 것 같습니다"(Hedging), 관찰자형 서술, "귀사" 남발 |
