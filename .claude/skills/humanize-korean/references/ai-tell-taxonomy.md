...
자소서의 진정성을 해치고 기계적인 인상을 주는 '학습된 자아' 패턴.

### K-1. 소심한 관찰자형 서술 [S1]
- 패턴: 경험이나 사건을 주어로 삼고, 화자를 수동적 객체로 서술.
- 예: "이 프로젝트는 저에게 소통의 중요성을 **가르쳐 주었습니다**" / "기회는 저를 **성장시켰습니다**"
- 처방: 화자를 주어로 복귀. "~를 통해 ~를 깨달았습니다", "~하며 역량을 길렀습니다"

### K-2. 상투적 결말 공식 [S1]
- 패턴: "이바지할 준비가 되어 있습니다", "열정을 다하겠습니다", "최선을 다할 것입니다" 등 구체성 없는 다짐.
- 처방: 구체적 기여 방안이나 행동 동사로 치환. "~에 기여하겠습니다", "~를 달성하겠습니다"

### K-3. 역량 나열형 병렬 구조 [S2]
- 패턴: "첫째는 소통, 둘째는 열정..." 식으로 역량을 단순 나열 (C-1 변종).
- 처방: 역량을 개별 에피소드(사례) 안으로 녹여내어 서사화. "A를 해결하며 소통 능력을 발휘했고, 그 결과 B를 얻었습니다"

### K-4. 범용 지칭어 "귀사" 남발 [S1]
- 패턴: 지원하는 회사의 이름을 쓰지 않고 "귀사", "이 회사", "이곳" 등으로 뭉뚱그려 지칭.
- 예: "**귀사**의 발전에 기여하고 싶습니다."
- 처방: 컨텍스트에 명시된 실제 사명(예: 삼성전자, 네이버 등)으로 치환하거나 문맥에 맞게 생략.

### K-5. 기술적 인과관계 오류 (Semantic Causal Mismatch) [S1]
- 패턴: 문장을 유려하게 만들려다 문제(Cause)와 해결책(Solution)을 뒤섞어 서술하는 현상.
- 예: "병목의 원인이었던 **쿼리 최적화**를 통해..." (최적화는 해결책이지 원인이 아님)
- 처방: 논리적 선후 관계를 명확히 함. "병목 지점이었던 **쿼리를 최적화**하여..."

---

## L. 이메일 특화 패턴 (Business Email Specifics) — S1~S2

비즈니스 메일의 간결함과 목적성을 해치는 AI 특유의 장황한 관습.

### L-1. 상투적 기후/건강 인사 [S1]
- 패턴: 업무 맥락과 관계없이 날씨나 건강을 묻는 템플릿형 인사말 (영어 `I hope this email finds you well`의 어색한 직역 변종).
- 예: "일교차가 큰 날씨에 건강 유의하시길 바라며..." / "풍성한 가을 되시길 바랍니다."
- 처방: 담백한 업무적 안부나 본론으로 직결. "오랜만에 연락드립니다", "공유드릴 건이 있어 메일 드립니다."

### L-2. 과도한 중복 감사/양해 [S2]
- 패턴: 한 통의 메일에 "감사합니다", "죄송합니다"를 문단마다 반복하여 전문성을 떨어뜨림.
- 처방: 핵심적인 감사/사과 1회로 압축하고 나머지는 업무 본론 서술.

### L-3. 기계적 요청 어법 [S1]
- 패턴: "~해주시면 감사하겠습니다"를 모든 요청 문장에 기계적으로 반복.
- 처방: "~ 부탁드립니다", "~를 확인해 주세요" 등 종결어미 변주 및 간결화.

### L-4. 수동적 관찰 서술 [S2]
- 패턴: 확신 없는 "~인 것 같습니다", "~인 것으로 확인됩니다" 남발 (본론 회피).
- 처방: 확인된 사실은 단언형(~입니다)으로, 의견은 "판단됩니다" 등으로 정제.
