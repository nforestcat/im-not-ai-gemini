...
- **지원 장르**: 칼럼, 리포트, 블로그, 공적, 자기소개서, **이메일** (장르를 명시하면 더 정확하게 윤문합니다.)
...
- **이메일 특화 규칙**: 업무와 상관없는 상투적인 날씨/건강 인사는 삭제하거나 간결한 비즈니스 안부로 대체한다. 반복적인 감사/사과 문구를 통합하여 메일의 목적을 명확히 드러내고, 제목은 명사형의 목적 중심(예: [요청]...)으로 개선한다.
